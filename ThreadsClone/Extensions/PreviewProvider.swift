...
class DeveloperPreview{
    ...
    let notfication  =  NotficationModel(notifcatonType: .like, fromUserID: "", noticationStatus: .unRead, refrence: "", timeStamp: Timestamp(), threadRef:Thread(ownerUid: "123", timeStamp: Timestamp(), caption: "hi   ", likes: 0,likesAcounts: [] ,repliesCount: 0,repliesAccounts: []))
